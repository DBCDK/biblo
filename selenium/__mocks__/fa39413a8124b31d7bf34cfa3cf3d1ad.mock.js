...
nock('http://localhost:3000', {"encodedQueryParams":true})
  ...
  date: 'Wed, 22 Jun 2016 13:21:39 GMT',
  connection: 'close',
...
nock('http://localhost:3000', {"encodedQueryParams":true})
  ...
  date: 'Wed, 22 Jun 2016 13:21:40 GMT',
  connection: 'close' });
...
nock('http://localhost:3000', {"encodedQueryParams":true})
  ...
  .query({"filter":"%7B%22include%22%3A%5B%22image%22%2C%22communityRoles%22%5D%7D","access_token":"2oDjA7K1rnbq0V46m2Q4SYg9TqzWMGEuIO2oVDWj2rIdGcBzz5BjTBGxdA6oU7RE"})
...
nock('https://dynamodb.eu-west-1.amazonaws.com:443', {"encodedQueryParams":true})
  ...
  .reply(200, {"Count":0,"Items":[],"ScannedCount":48}, { 'x-amzn-requestid': '96IOG2NRQR74U07TOASVLT17DVVV4KQNSO5AEMVJF66Q9ASUAAJG',
...
nock('https://dynamodb.eu-west-1.amazonaws.com:443', {"encodedQueryParams":true})
  .post('/', {"TableName":"biblo_development_local_message_table","IndexName":"uderId-message-index","FilterExpression":"userId = :userId","ExpressionAttributeValues":{":userId":{"S":"user_42727"}}})
  .reply(200, {"Count":0,"Items":[],"ScannedCount":48}, { 'x-amzn-requestid': 'P7R4V0FJQ3HG20NQRQ7MK3SIURVV4KQNSO5AEMVJF66Q9ASUAAJG',
  'x-amz-crc32': '1137651181',
  'content-type': 'application/x-amz-json-1.0',
  'content-length': '40',
  date: 'Wed, 22 Jun 2016 13:21:41 GMT' });
...
nock('https://dynamodb.eu-west-1.amazonaws.com:443', {"encodedQueryParams":true})
  .post('/', {"TableName":"biblo_development_local_message_table","IndexName":"uderId-message-index","FilterExpression":"userId = :userId","ExpressionAttributeValues":{":userId":{"S":"user_42727"}}})
  .reply(200, {"Count":0,"Items":[],"ScannedCount":48}, { 'x-amzn-requestid': 'TD82DCNN5EURTBQS9CGQB7EAMJVV4KQNSO5AEMVJF66Q9ASUAAJG',
  'x-amz-crc32': '1137651181',
  'content-type': 'application/x-amz-json-1.0',
  'content-length': '40',
  date: 'Wed, 22 Jun 2016 13:21:40 GMT' });
...
nock('https://dynamodb.eu-west-1.amazonaws.com:443', {"encodedQueryParams":true})
  .post('/', {"TableName":"biblo_development_local_message_table","IndexName":"uderId-message-index","FilterExpression":"userId = :userId","ExpressionAttributeValues":{":userId":{"S":"user_42727"}}})
  .reply(200, {"Count":0,"Items":[],"ScannedCount":48}, { 'x-amzn-requestid': 'D8NV7CF64P7OT4NT21OVEMQKD3VV4KQNSO5AEMVJF66Q9ASUAAJG',
  'x-amz-crc32': '1137651181',
  'content-type': 'application/x-amz-json-1.0',
  'content-length': '40',
  date: 'Wed, 22 Jun 2016 13:21:41 GMT' });
...
nock('http://localhost:3000', {"encodedQueryParams":true})
  ...
  'access-control-allow-credentials': 'true',
  'content-type': 'application/json',
  date: 'Wed, 22 Jun 2016 13:21:42 GMT',
  connection: 'close',
  'transfer-encoding': 'chunked' });
