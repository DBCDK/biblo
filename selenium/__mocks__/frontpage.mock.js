...
module.exports = function frontpage (times) {
                ...
                nock('http://uxscrum-i02.dbc.dk:8889', {encodedQueryParams: true})
                  ...
                  .times(times)
                  .query({"_format":"json"})
                  .reply(200, {"nid":"8","type":"section_page","title":"frontpage","status":"1","created":"1473759370","changed":"1473759396","field_content":[{"widgetName":"ContentPageTextWidget","widgetConfig":{"content":"<p>This is the frontpage</p>"}}]});};
