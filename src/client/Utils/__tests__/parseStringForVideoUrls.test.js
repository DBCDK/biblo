...
describe('Testing the parseStringForVideoUrls.js util', () => {
  ...
  it('it should return an array with one player', () => {
    ...
    const expectedSerializedVideoPlayer = '{"key":null,"ref":null,"props":{"url":"https://vimeo.com/76839641","config":{"youtube":{"playerVars":{"controls":1}}},"playing":false,"loop":false,"controls":false,"volume":0.8,"muted":false,"playbackRate":1,"width":640,"height":360,"style":{},"progressFrequency":1000,"playsinline":false},"_owner":null,"_store":{}}'; // eslint-disable-line
