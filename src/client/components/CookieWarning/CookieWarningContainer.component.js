    ...
    return (
      ...
      <ModalWindow onClose={this.onClose.bind(this)} >
        <div className="cookie-warning" >
          ...
          <span className="cookie-warning--message" >Biblo bruger cookies til at huske dine indstillinger og til statistik. Læs mere om cookies under "Spørgsmål og svar" nederst på siden.</span>
