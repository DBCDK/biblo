...
describe('Test of Comment Components', () => {
  ...
  describe('Test toggle Comment Input Component', () => {
    ...
    it('it should show comment-ad-button before click', () => {
      ...
      TestUtils.findRenderedDOMComponentWithClass(component, 'comment-add-button');
    });
    it('it should show AddComment Component after click', () => {
      let button = TestUtils.findRenderedDOMComponentWithClass(component, 'comment-add-button');
      TestUtils.Simulate.click(button);
      expect(component.state.isCommentInputVisible).to.be.equal(true);
      button = TestUtils.scryRenderedDOMComponentsWithClass(component, 'comment-add-button');
