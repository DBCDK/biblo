...
ProfileRoutes.delete('/:id', ensureAuthenticated, async (req, res) => {
  const profileId = req.params.id;

  // TODO check if user is alowed to delete (reuse logic from editProfile)

  const deleteResponse = await req.callServiceProvider('deleteProfile', {
    id: profileId
  });

  // TODO Check if reponse is ok
  // TODO Log out user
